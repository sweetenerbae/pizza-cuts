    ...
    <main>
      ...
      <section className="calculator" aria-label="Калькулятор разреза пиццы">
        ...
        <div className="visual-panel"><div className="visual-top"><span><span className="status-dot"/> {cut?'ПЛАН РАЗРЕЗА':'ПИЦЦА В ЦЕЛОСТИ'}</span><span>ВИД СВЕРХУ ↙</span></div>
          <div className="pizza-stage"><div className="pizza-wrap"><picture><source srcSet="/pizza.webp" type="image/webp"/><img src="/pizza.png" alt="Пиксельная пицца с пепперони, вид сверху"/></picture><svg viewBox="0 0 400 400" role="img" aria-label={`Схема: ${people} равных частей, угол ${fmt(angle)} градуса`}>
